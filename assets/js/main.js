    ...
    let html = `
        <li class="nav-search-item">
          <div class="nav-search-bar">
            ...
            <input type="text" id="navSearchInput" placeholder="ابحث عن منتج..." autocomplete="off" oninput="performNavSearch()" onkeydown="if(event.key==='Enter'){event.preventDefault();performNavSearch();}">
          </div>
