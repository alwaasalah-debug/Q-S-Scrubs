async function renderProducts(filter = 'all') {
    ...
    // Show loading state
    container.innerHTML = '<div style="grid-column: 1/-1; text-align: center; padding: 40px;"><p>جاري تحميل الاسكرابات...</p></div>';
    ...
    if (filteredProducts.length === 0) {
        container.innerHTML = '<p style="grid-column: 1/-1; text-align: center;">لا توجد اسكرابات متاحة حالياً.</p>';
        return;
    }
...
function initStaticCategories() {
    ...
    const categories = [
        { name: 'V-Neck', title: '(V-Neck)', img: 'assets/images/v-neck.jpg' },
        { name: 'High Neck', title: '(High Neck)', img: 'assets/images/high-neck.jpg' },
        { name: 'Jacket', title: '(Jacket)', img: 'assets/images/jacket.jpg' }
    ];
