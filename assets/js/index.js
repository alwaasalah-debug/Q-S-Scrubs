...
async function renderCategoriesHome() {
    ...
    container.innerHTML = '<p style="text-align:center; grid-column: 1/-1;">جاري تحميل الأقسام...</p>';

    // Depends on storage.js getCategories
    ...
    try {
        ...
        if (!categories || categories.length === 0) {
            container.innerHTML = '<p style="text-align:center; grid-column: 1/-1;">لا توجد أقسام مضافة حالياً.</p>';
            return;
        }
        ...
        categories.forEach(cat => {
            ...
            const imgSrc = cat.image_url || 'assets/images/placeholder.jpg';
            ...
            el.addEventListener('click', () => {
                // Navigate or filter
                // If on same page, can filter, or navigate to index.html?category=
                window.location.href = `index.html?category=${cat.label}`;
            });
        ...
        container.innerHTML = '<p style="text-align:center; grid-column: 1/-1; color: red;">حدث خطأ أثناء تحميل الأقسام.</p>';
    }
}
